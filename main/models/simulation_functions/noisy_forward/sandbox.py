import pickle
path = '../../td_simulations/td1_numStimuli3_numActions4.p'
...
import smc2
smc2.SMC2(td, lambdaa=.9, eta=5., show_progress=True, numberOfStateSamples=1000, numberOfThetaSamples=200, coefficient = .5)
