...
def L1(distribution1, distribution2, par_confirmed, par_disconfir):
        ...
        du        = np.abs(proba0old - proba0new) * (confirmed * par_confirmed + disconfir * par_disconfir)
...
def smc(actions, rewards, parameters, nb_samples = 1000):
    ...
    for t_idx in range(T):
        ...
        if t_idx > 0:
            ...
            variances_beta   = variances_beta + np.random.rand(average_noise.shape[0]) * distances
