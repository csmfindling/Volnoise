...
# show_progress=False;beta_softmax=1.; numberOfStateSamples=200; numberOfThetaSamples=200; coefficient = .5; numberOfBetaSamples=40; #import generate_task as gt; td = gt.generate_task(300)
def SMC2(td, beta_softmax=1., numberOfStateSamples=200, numberOfThetaSamples=200, numberOfBetaSamples=50, coefficient = .5, latin_hyp_sampling=True):
    ...
    for T in range(numberOfTrials):
        ...
        # assert(all(betaAncestors==np.arange(numberOfBetaSamples)))
