...
nb_points = 10000
r = np.arange(0, 1, 1./nb_points)
vals_ppf = invgamma.ppf(r, a) * b
vals_rvs = useful_functions.sample_inv_gamma(a, b, nb_points)

invgamma.ppf(r[10], a) * b

from scipy.special import gammaincinv, gammainc, gamma, gammaincc, gammainccinv 

# gamma distribution
print gammainc(a, r[10])
print gammalib.cdf(r[10], a)

# invgamma distribution
b = .01
print gammaincc(a, b/r[10])
print invgamma.cdf(r[10]/b, a)

# ppf invgamma distribution
b = .01
print b/gammainccinv(a, r[10])
print b * invgamma.ppf(r[10], a)


from scipy.stats import ks_2samp
print(ks_2samp(vals_ppf, vals_rvs))
