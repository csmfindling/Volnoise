...
# show_progress=True; numberOfStateSamples=200; numberOfThetaSamples=200; coefficient = .5; beta_softmax=1.; numberOfBetaSamples=30 ;alpha=0.; import generate_task as gt; td = gt.generate_task(300)
