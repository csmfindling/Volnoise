...
cdef extern from "SMCfunctions.hpp" namespace "smc":
    ...
    # void bootstrapUpdateStep(int* currentRes, double* logThetaWeights, double* gammaList, double* betaList, double* tauList, int t, int* ancestorsList, double* weightsList, \
    #                                 int* mapping, int currentStimulus, int action, int reward, int numberOfThetaSamples, int numberOfStateSamples, \
    #                                             int K, int numberOfStimuli);

    # double guided_bootstrap(int* currentRes, double* logThetaWeights, double* gammaList, double* betaList, double* tauList, int t, int* ancestorsList, double* weightsList, int* mapping, int currentStimulus, int action, int reward, int numberOfThetaSamples, int numberOfStateSamples, int K, int numberOfStimuli, int new_action, int new_stim, double beta, double alpha);
