...
void stratified_resampling(double generator, double uniformSample, double weights[], int dim, int* ancestorsIndexes, double sum_weights, double temperature);

void stratified_resampling(double uniformSample, double weights[], int dim, int* ancestorsIndexes, double sum_weights);

std::vector<int> Sample_Discrete_Distribution(boost::mt19937 &generator, double* probabilities, int dimension, int numberOfSamples);
