...
cdef extern from "smc_functions.hpp" namespace "smc":
    # double guided_smc(int* candidateTaskSetSamples, int T, double* temperaturesList, double candidateParamBeta, double* candidateParamGamma,
    #                                  int* mapping, int numberOfStimuli, int K, int* stimuli, int* rewards, int* actions, int numberOfLatentSamples);
